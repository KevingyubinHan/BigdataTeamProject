...
def calc_psi(binned_train_df, binned_valid_df, binned_test_df,
             binned_model_valid_df, performance_table, psi_value, use_columns_list, category_columns_list):
    """
    ...
    for variable in use_columns_list:
        ...
        performance_table.loc[variable, 'PSI_선정여부'] = ('N' if ((performance_table.loc[variable, 'val_psi'] >= psi_value) |
...
def select_candidate_variable(binned_train_df, binned_valid_df, binned_test_df,
                              ...
                              psi_value, top_value, stable_value, corr_value):
    """
